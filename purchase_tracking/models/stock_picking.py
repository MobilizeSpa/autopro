...
class StockPicking(models.Model):
    ...
    def send_message_in(self):
        ...
        try:
            template_id = ir_model_data.get_object_reference('purchase_tracking', 'email_template_stock_picking_in')[1]
        except ValueError:
            template_id = False
        try:
    ...
    def send_message_out(self):
        ...
        ir_model_data = self.env['ir.model.data']
        try:
            template_id = ir_model_data.get_object_reference('purchase_tracking', 'email_template_stock_picking_out')[1]
        except ValueError:
            template_id = False
        try:
            compose_form_id = ir_model_data.get_object_reference('mail', 'email_compose_message_wizard_form')[1]
